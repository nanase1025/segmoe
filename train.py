...
from utils import FocalDiceloss_IoULoss, get_logger, generate_point, setting_prompt_none, print_model_parameters
...
def parse_args():
    ...
    # parser.add_argument("--model_type", type=str, default="vit_b_softmoe_adapter", help="sam model_type")
    # parser.add_argument("--model_type", type=str, default="vit_b_sparsemoe_adapter", help="sam model_type")
    parser.add_argument("--model_type", type=str, default="vit_b_softmoe", help="sam model_type")
    # parser.add_argument("--model_type", type=str, default="vit_b_sparsemoe", help="sam model_type")
    parser.add_argument("--sam_checkpoint", type=str, default="pretrain_model/sam_vit_b.pth", help="sam checkpoint")
...
def main(args):
    ...
    """-------------------------------------------------------------------------------------"""
    # this is the code lines about how to flexibly know the params of some layers
    
    idx = 0
    for block in model.image_encoder.blocks:
        total_params = 0
        
        for param in block.moe.layer.experts[0].parameters():
            total_params += param.numel()
        print(f"Mlp Layer{idx} params:{total_params}")
        
        # for param in block.moe.layer.gating_network.parameters():
        #     total_params += param.numel()
        # print(f"Mlp Layer{idx} params:{total_params}")
